...
export function Hero() {
  return (
    <div className="bg-blue-900 pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-4">
          ...
          <Link
            to="/demo"
            className="inline-flex items-center px-6 py-3 border border-blue-300 text-base font-medium rounded-md text-white hover:bg-blue-800 transition-colors"
          >
            Try Extraction Demo
          </Link>
        </div>
