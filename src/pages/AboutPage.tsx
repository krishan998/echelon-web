          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Nexbit was founded in 2024 with a simple goal: to eliminate the inefficiencies of manual document processing. We saw businesses struggling with paperwork, spending hours on tasks that should take seconds. So, we built a solution that streamlines the process, giving businesses the power to extract insights and automate actions effortlessly.
              </p>
            </div>
            <div>
