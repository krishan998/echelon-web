        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {securityFeatures.map((feature, index) => (
              <div key={index} className="bg-light-50 rounded-lg p-8 border border-light-200">
                <div className="flex items-center mb-6">
                  <div className="p-3 bg-light-100 rounded-lg mr-4">
          ...
          <div className="bg-light-50 rounded-lg p-8 border border-light-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-black mb-4">Infrastructure Security</h3>
                <ul className="space-y-2 text-black">
                  <li>• Azure infrastructure with multiple availability zones</li>
              ...
              <div>
                <h3 className="text-xl font-semibold text-black mb-4">Data Protection</h3>
                <ul className="space-y-2 text-black">
